...
# @displayName  System Health Check (POSIX)
...
# Example: curl -fsSL https://codefuturist.github.io/remote-script-runner/scripts/sh/system-health-check.sh | sh -s -- -v -s cpu memory disk -t 5
